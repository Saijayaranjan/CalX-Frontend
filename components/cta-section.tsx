    ...
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-2xl sm:text-3xl md:text-5xl lg:text-[68px] font-semibold leading-tight md:leading-tight lg:leading-[76px] sm:whitespace-nowrap">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Set up your CalX dashboard in minutes. Connect your device, configure AI settings, and start calculating smarter.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto px-4 sm:px-0">
          <Link href="/login" className="w-full sm:w-auto">
            <Button
              className="w-full sm:w-auto px-6 sm:px-[30px] py-2.5 bg-secondary text-secondary-foreground text-sm sm:text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] hover:bg-secondary/90 transition-all duration-200"
              size="lg"
            >
              Create Account
            </Button>
          ...
          <Link href="/dashboard" className="w-full sm:w-auto">
            <Button
              variant="outline"
              className="w-full sm:w-auto px-6 sm:px-[30px] py-2.5 border-border text-foreground text-sm sm:text-base font-medium leading-6 rounded-[99px] hover:bg-accent/50 transition-all duration-200"
              size="lg"
            >
              Try Dashboard Demo
            </Button>
